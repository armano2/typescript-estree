...
export default class Converter extends AbstractConverter {
  [SyntaxKind.SourceFile](node: ts.SourceFile): es.Program {
    const result = this.createNode<es.Program>(node, {
  ...
  [SyntaxKind.Block](node: ts.Block): es.BlockStatement {
    const result = this.createNode<es.BlockStatement>(node, {
  ...
  [SyntaxKind.Identifier](node: ts.Identifier): es.Identifier {
  ...
  [SyntaxKind.WithStatement](node: ts.WithStatement): es.WithStatement {
  ...
  [SyntaxKind.ReturnStatement](node: ts.ReturnStatement): es.ReturnStatement {
  ...
  [SyntaxKind.BreakStatement](node: ts.BreakStatement): es.BreakStatement {
  ...
  [SyntaxKind.IfStatement](node: ts.IfStatement): es.IfStatement {
  ...
  [SyntaxKind.SwitchStatement](node: ts.SwitchStatement): es.SwitchStatement {
    return this.createNode(node, {
  ...
  [SyntaxKind.CaseClause](node: ts.CaseClause): es.CaseClause {
    return this.createNode(node, {
  ...
  [SyntaxKind.DefaultClause](node: ts.DefaultClause): es.DefaultClause {
    return this.createNode(node, {
      type: AST_NODE_TYPES.SwitchCase,
      // expression is present in case only
      test: null,
  ...
  [SyntaxKind.ThrowStatement](node: ts.ThrowStatement): es.ThrowStatement {
    return this.createNode(node, {
  ...
  [SyntaxKind.TryStatement](node: ts.TryStatement): es.TryStatement {
    return this.createNode(node, {
  ...
  [SyntaxKind.CatchClause](node: ts.CatchClause): es.CatchClause {
    return this.createNode(node, {
  ...
  [SyntaxKind.WhileStatement](node: ts.WhileStatement): es.WhileStatement {
    return this.createNode(node, {
   ...
   * a "DoStatement"
   */
  [SyntaxKind.DoStatement](node: ts.DoStatement): es.DoWhileStatement {
    return this.createNode(node, {
  ...
  [SyntaxKind.ForStatement](node: ts.ForStatement): es.ForStatement {
    return this.createNode(node, {
  ...
  [SyntaxKind.ForInStatement](node: ts.ForInStatement): es.ForInStatement {
    return this.createNode(node, {
  ...
  [SyntaxKind.ForOfStatement](node: ts.ForOfStatement): es.ForOfStatement {
    return this.createNode(node, {
      type: SyntaxKind[node.kind],
      left: this.convert(node.initializer),
      right: this.convert(node.expression),
  ...
  [SyntaxKind.FunctionDeclaration](
    ...
    // Process returnType
    if (node.type) {
      result.returnType = this.convertTypeAnnotation(node.type);
    }
  ...
  [SyntaxKind.ThisKeyword](node: ts.ThisExpression): es.ThisExpression {
    return this.createNode(node, {
  ...
  ): es.ObjectPattern | es.ObjectExpression {
  ...
  [SyntaxKind.PropertyDeclaration](
    ...
    if (node.decorators) {
      result.decorators = node.decorators.map(el => this.convert(el));
    }
  ...
  convertMethodDeclaration(
    ...
    const methodLoc = this.ast.getLineAndCharacterOfPosition(
      ...
      method = {
        ...
        loc: {
          start: { line: methodLoc.line + 1, column: methodLoc.character },
          end: result.loc.end
        }
      };
  ...
  [SyntaxKind.SuperKeyword](node: ts.SuperExpression): es.SuperExpression {
    return this.createNode(node, {
  ...
  [SyntaxKind.ArrowFunction](node: ts.ArrowFunction): es.ArrowFunction {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.YieldExpression](node: ts.YieldExpression): es.YieldExpression {
    return this.createNode(node, {
  ...
  [SyntaxKind.AwaitExpression](node: ts.AwaitExpression): es.AwaitExpression {
    return this.createNode(node, {
  ...
  [SyntaxKind.TemplateHead](node: ts.TemplateHead): es.TemplateHead {
    return this.convertTemplateParts(node);
  }

  [SyntaxKind.TemplateMiddle](node: ts.TemplateMiddle): es.TemplateMiddle {
    return this.convertTemplateParts(node);
  }

  [SyntaxKind.TemplateTail](node: ts.TemplateTail): es.TemplateTail {
    return this.convertTemplateParts(node);
  }

  // Patterns

  [SyntaxKind.SpreadElement](node: ts.SpreadElement): es.SpreadElement {
  ...
  [SyntaxKind.Parameter](
    ...
    if (node.type) {
      parameter!.typeAnnotation = this.convertTypeAnnotation(node.type);
  ...
  [SyntaxKind.ClassExpression](node: ts.ClassExpression): es.ClassExpression {
    return this.convertClassLike(node);
  }

  // Modules
  [SyntaxKind.ModuleBlock](node: ts.ModuleBlock): es.ModuleBlock {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.NamespaceImport](node: ts.NamespaceImport): es.NamespaceImport {
    return this.createNode(node, {
  ...
  [SyntaxKind.ImportSpecifier](node: ts.ImportSpecifier): es.ImportSpecifier {
    return this.createNode(node, {
  ...
  [SyntaxKind.ImportClause](node: ts.ImportClause): es.ImportClause {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.ExportSpecifier](node: ts.ExportSpecifier): es.ExportSpecifier {
    return this.createNode(node, {
  ...
  [SyntaxKind.VoidExpression](node: ts.VoidExpression): es.VoidExpression {
    return this.createNode(node, {
      type: AST_NODE_TYPES.UnaryExpression,
      operator: 'void',
      prefix: true,
  ...
  [SyntaxKind.TypeOperator](node: ts.TypeOperatorNode): es.TypeOperatorNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.CallExpression](node: ts.CallExpression): es.CallExpression {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.NewExpression](node: ts.NewExpression): es.NewExpression {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.MetaProperty](node: ts.MetaProperty): es.MetaProperty {
  ...
  [SyntaxKind.NumericLiteral](node: ts.NumericLiteral): es.NumericLiteral {
    const result = this.createNode(node, {
      type: AST_NODE_TYPES.Literal,
  ...
  [SyntaxKind.BigIntLiteral](node: ts.BigIntLiteral): es.BigIntLiteral {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.TrueKeyword](node: ts.BooleanLiteral): es.BooleanLiteral {
    return this.createNode(node, {
      type: AST_NODE_TYPES.Literal,
      value: true,
      raw: 'true'
  ...
  [SyntaxKind.FalseKeyword](node: ts.BooleanLiteral): es.BooleanLiteral {
    return this.createNode(node, {
      type: AST_NODE_TYPES.Literal,
      value: false,
      raw: 'false'
  ...
  [SyntaxKind.ImportKeyword](node: ts.ImportExpression): es.ImportExpression {
    return this.createNode(node, {
      type: AST_NODE_TYPES.Import
    });
  }

  [SyntaxKind.EmptyStatement](node: ts.EmptyStatement): es.EmptyStatement {
    return this.createNode(node, {
  ...
  [SyntaxKind.JsxElement](node: ts.JsxElement): es.JsxElement {
    return this.createNode(node, {
  ...
  [SyntaxKind.JsxFragment](node: ts.JsxFragment): es.JsxFragment {
    return this.createNode(node, {
  ...
  [SyntaxKind.JsxExpression](node: ts.JsxExpression): es.JsxExpression {
    const result = this.createNode(node, {
    ...
    if (node.expression) {
      ...
      result.expression = {
        ...
        loc: {
          start: { line: eloc.line + 1, column: eloc.character },
          end: { line: result.loc.end.line, column: result.loc.end.column - 1 }
        },
  ...
  [SyntaxKind.JsxAttribute](node: ts.JsxAttribute): es.JsxAttribute {
   ...
   */
  [SyntaxKind.JsxText](node: ts.JsxText): es.JsxText {
  ...
  [SyntaxKind.QualifiedName](node: ts.QualifiedName): es.QualifiedName {
    return this.createNode(node, {
  ...
  [SyntaxKind.TypeReference](node: ts.TypeReferenceNode): es.TypeReferenceNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.ThisType](node: ts.ThisTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSThisType);
  }
  [SyntaxKind.AnyKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSAnyKeyword);
  }
  [SyntaxKind.BigIntKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSBigIntKeyword);
  }
  [SyntaxKind.BooleanKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSBooleanKeyword);
  }
  [SyntaxKind.NeverKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSNeverKeyword);
  }
  [SyntaxKind.NumberKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSNumberKeyword);
  }
  [SyntaxKind.ObjectKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSObjectKeyword);
  }
  [SyntaxKind.StringKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSStringKeyword);
  }
  [SyntaxKind.SymbolKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSSymbolKeyword);
  }
  [SyntaxKind.UnknownKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSUnknownKeyword);
  }
  [SyntaxKind.VoidKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSVoidKeyword);
  }
  [SyntaxKind.UndefinedKeyword](node: ts.KeywordTypeNode): es.KeywordTypeNode {
    return this.createSimpleNode(node, AST_NODE_TYPES.TSUndefinedKeyword);
  }

  [SyntaxKind.NonNullExpression](
    node: ts.NonNullExpression
  ): es.NonNullExpression {
    return this.createNode(node, {
  ...
  [SyntaxKind.TypeLiteral](node: ts.TypeLiteralNode): es.TypeLiteralNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.ArrayType](node: ts.ArrayTypeNode): es.ArrayTypeNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.TypeQuery](node: ts.TypeQueryNode): es.TypeQueryNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.MappedType](node: ts.MappedTypeNode): es.MappedTypeNode {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.MethodSignature](node: ts.MethodSignature): es.MethodSignature {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.TypePredicate](node: ts.TypePredicateNode): es.TypePredicateNode {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.ImportType](node: ts.ImportTypeNode): es.ImportTypeNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.EnumDeclaration](node: ts.EnumDeclaration): es.EnumDeclaration {
  ...
  [SyntaxKind.EnumMember](node: ts.EnumMember): es.EnumMember {
    const result = this.createNode(node, {
  ...
  [SyntaxKind.OptionalType](node: ts.OptionalTypeNode): es.OptionalTypeNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.TupleType](node: ts.TupleTypeNode): es.TupleTypeNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.UnionType](node: ts.UnionTypeNode): es.UnionTypeNode {
    return this.createNode(node, {
  ...
  [SyntaxKind.RestType](node: ts.RestTypeNode): es.RestTypeNode {
    return this.createNode(node, {
